...
class ListFilterDataComponent extends StatefulWidget {
  const ListFilterDataComponent(this.data, {super.key});

  final List<BloodPressureEntity> data;

  @override
  State<ListFilterDataComponent> createState() => _ListFilterDataComponentState();
}

class _ListFilterDataComponentState extends State<ListFilterDataComponent> {
  @override
              ...
              children: <Widget>[
                SizedBox(
                  child: Row(
                    children: <Widget>[
                      SizedBox(
                        child: Text(
                          widget.data[index].measurementValue.toString(),
                ...
                SizedBox(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        widget.data[index].measurementDescriptionDate,
                        style: AppStyleDesign.fontStyleInter(
                          context: context,
                      ...
                      Text(
                        widget.data[index].measurementTime,
                        style: AppStyleDesign.fontStyleInter(
                          context: context,
                          size: size.height * .012,
                          fontWeight: FontWeight.w400,
